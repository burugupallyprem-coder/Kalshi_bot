...
<div class="banner">PAPER ACCOUNT ONLY · LIVE ENDPOINT CODE-LOCKED · CANDIDATE (paper trial): filtered ORB (PASS 2026-07-18 - backtest edge, 21-session trial) · premarket guard: {guard}</div>
<div class="grid">
  ...
  <div class="card"><h2>CANDIDATE CONFIG (filtered ORB)</h2>
